        ...
        <div>
            <nav className="bg-myprimecolor z-10 h-16 flex justify-between items-center pl-2 md:pl-10 md:pr-10 pr-4 fixed w-full" >
                ...
                <div className="hidden lg:flex  absolute right-28 md:relative md:right-auto  text-2xl md:text-4xl gap-5">
                    <Link href={"https://www.linkedin.com/in/rohan-moura-66486527b/"} className="transition ease-in-out   hover:-translate-y-1 hover:scale-110 cursor-pointer"><AiFillLinkedin /></Link>
                    <Link href={"https://x.com/_rohanmoura_94"} className="transition ease-in-out   hover:-translate-y-1 hover:scale-110 cursor-pointer"><FaSquareXTwitter /></Link>
                    <Link href={"https://github.com/rohanmoura"} className="transition ease-in-out   hover:-translate-y-1 hover:scale-110 cursor-pointer"><AiOutlineGithub /></Link>
                </div>
