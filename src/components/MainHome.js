...
import { BsDownload, BsGrid } from "react-icons/bs";
const worksans = Work_Sans({ subsets: ['latin'], weight: ["700"] })
import HomePageBg from "../../public/images/homepagebg.jpg"

export default function MainHome() {
    return (
        <div className='relative'>
            <Image src={HomePageBg} width={2000} height={2000} className='h-screen w-full' alt='homebg' />
            <div className='flex justify-center'>
                <div data-aos="zoom-in" className='absolute top-[30vh] md:top-[35vh] flex flex-col gap-5 justify-center items-center text-black'>
                    ...
                    <h1  className={`text-center text-5xl md:text-6xl`} >I am <span className={`${worksans.className}`}>Rohan Moura</span><span  className='text-4xl md:text-5xl text-myprimecolor font-black ml-2'>.</span></h1>
                    ...
                    <div  className='flex gap-5 flex-col md:flex-row'>
                        ...
                        <a href="Rohan_Resume.pdf" target="_blank" rel="noopener noreferrer"
                            download="Rohan Moura Resume" className='hover:-translate-y-2 ease-in-out transition hover:scale-105 flex  justify-center items-center  gap-2 bg-myprimecolor  text-white text-lg md:text-2xl p-2 rounded-md px-3'><BsDownload />Download Resume</a>
                    </div>
                </div>
            </div>
